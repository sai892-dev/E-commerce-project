...
async function seedDatabaseIfEmpty() {
  // Force a re-seed to fix mismatched images
  console.log("Dropping database to fix image mismatches and re-seeding massive catalog...");
  ...
  console.log("Generating 10,000 perfectly matched products...");
  let batch = [];
  ...
  console.log("Massive 10,000 product seeding completed successfully with matched images!");
}
